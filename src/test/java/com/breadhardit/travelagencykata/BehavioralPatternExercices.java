  ...
  */
  ...
  public void travelAgency() {
    ...
    for (Travel travel : travels) {
      TravelDocument travelDocument =
          new TravelDocument(TravelFactory.getStrategy(travel.origin, travel.destination));
  ...
  public static class EmployeesRepository {
    ...
    public void addEmployee(Employee employee) {
      ...
      NOTIFICATION_OBSERVERS.forEach(
          e -> e.notify(employee, new Notification(employee.getEmail(), "Hello there")));
    }
  ...
  public static class GreetingsNotificatorObserver implements NotificationObserver {
    ...
    public void notify(Employee employee, Notification greetinsNotification) {
      log.info(
          "Sending email to {} with context: {}",
          greetinsNotification.getEmail(),
          greetinsNotification.getText());
  ...
  public void companyTest() {
    ...
    GreetingsNotificatorObserver greetingsNotificatorObserver =
        new GreetingsNotificatorObserver(employeesRepository);
